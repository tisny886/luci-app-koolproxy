...
wget 'https://cdn.jsdelivr.net/gh/houzi-/CDN/koolproxy.txt' -O files/usr/share/koolproxy/data/rules/koolproxy.txt
wget ' https://cdn.jsdelivr.net/gh/houzi-/CDN/daily.txt' -O files/usr/share/koolproxy/data/rules/daily.txt
